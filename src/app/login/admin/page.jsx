...
export default function LoginAdmin() {
    ...
    const SubmitLogin = async (e) => {
        ...
        try {
            const res = await fetch('/api/login/loginadmin', {
                method: 'POST',
                headers: {
        ...
        <div className="p-10">
            ...
            <div className="p-5 flex justify-center">
                <div className="bg-[#D2CBB1] p-5 rounded-3xl w-lg">
                    <h1 className="text-center font-[MontserratBold] text-[#273529] font-extrabold text-3xl py-2">SELAMAT DATANG ADMIN</h1>
